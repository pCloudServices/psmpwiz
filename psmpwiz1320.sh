...
newVersionFile="CARKpsmp-13.2.0.15.x86_64.rpm"                #update this locally
newIntergratedInfraFile="CARKpsmp-infra-13.2.0.15.x86_64.rpm" #update this locally

#packagenames (this goes with every -qa command)
newVersion="CARKpsmp-13.2.0-15.x86_64"       #UPDATE this to the latest version always (It's usually diff than the .rpm file we define above, it has dash instead of dot.)
...
disableNSCD() {
    ...
    echo "**** Checking if $nscdname password caching needs to be disabled...."
