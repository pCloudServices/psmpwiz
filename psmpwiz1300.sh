...
VERSION_PSMP="v13.0" # UPDATE THIS (This is just for UI sake, it doesn't impact anything in the script)
...
newVersionFile="CARKpsmp-13.00.0.7.x86_64.rpm"
newLibSSHFile="libssh-0.9.4.x86_64.rpm"
newIntergratedInfraFile="CARKpsmp-infra-13.00.0.7.x86_64.rpm"

#packagenames (this goes with every -qa command)
newVersion="CARKpsmp-13.00.0-7.x86_64" #UPDATE this to the latest version always (It's usually diff than the .rpm file we define above, it has dash instead of dot.)
