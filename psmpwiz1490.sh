...
VERSION_PSMP="v14.8" # UPDATE THIS (This is just for UI sake, it doesn't impact anything in the script)
...
newVersionFile="CARKpsmp-14.1.5.4.x86_64.rpm"                #update this locally
newIntergratedInfraFile="CARKpsmp-infra-14.1.5.4.x86_64.rpm" #update this locally

#packagenames (this goes with every -qa command)
newVersion="CARKpsmp-14.1.5-4.x86_64"       #UPDATE this to the latest version always (It's usually diff than the .rpm file we define above, it has dash instead of dot.)
newVersionSha256="f7e0bf40dc07bd32b2e9945fd8f88352fe6bc71112873e6e3973c6b5e448404f" # UPDATE this, example command: sha256sum CARKpsmp-14.1.1.4.x86_64.rpm | awk '{print $1}' 
