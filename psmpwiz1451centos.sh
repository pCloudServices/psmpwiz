...
VERSION_PSMP="v14.5.1" # UPDATE THIS (This is just for UI sake, it doesn't impact anything in the script)
...
newVersionSha256="aed2f7629e4b53fd03ba4b166a8e913db97eab2d5a45337f317dd25c94bbe3b0" # UPDATE this, example command: sha256sum CARKpsmp-14.1.1.4.x86_64.rpm | awk '{print $1}' 
